...
//	SeleniumDriver driver = new SeleniumDriver();
	...
	public void i_enter_an_invalid_username() throws InterruptedException {
		...
		loginPageActions.EnterUserName("Harry");
		Thread.sleep(4000);
	...
	public void i_enter_an_invalid_password() throws InterruptedException {
		...
		loginPageActions.EnterPassword("Harry123");
...
//	@Then("user should see a prompt that states that the user already exists")
//	public void user_should_see_a_prompt_that_states_that_the_user_already_exists() {
//	 
//		Alert alt = driver.switchTo().alert();
//		 
//String AlertMessage = alt.getText();
//System.out.println("this is mesage" + AlertMessage);
